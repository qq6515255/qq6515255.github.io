...
// 滑动条类
function Progress($voiceLine, $ball, $activeLine) {
    return new Progress.prototype.init($voiceLine, $ball, $activeLine);
}
Progress.prototype = {
        constructor: Progress,
        init: function($mainLine, $ball, $activeLine) {
...
playBtn();
//  构建音量滑动条类
var progress = Progress($('.right-box .voice-line'), $('.right-box .ball'), $('.right-box .active-line'));
var progressMain = Progress($('.lineBox .song-line'), $('.lineBox .ball'), $('.lineBox .active-line'));
// 音量条实例
